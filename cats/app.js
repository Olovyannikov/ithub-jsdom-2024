// https://cats.petiteweb.dev/simple/assets/cats.js сервис не работает в рф
const cats = [
    {
        "name": "Лара",
        "img_link": "/2021-09/167200DD-A44F-4845-8D4D-ACCFC180165A.jpeg",
        "age": 8,
        "rate": 7,
        "favourite": false,
    ...
    {
        "name": "Базиль",
        "img_link": "/2022-01/064AEBCB-45EC-4CE7-AB13-C65F10F00B7B.jpeg",
        "age": 2,
        "rate": 10,
        "favourite": false,
    ...
    {
        "name": "Чарли",
        "img_link": "/2022-01/%D0%BB%D0%B5%D0%B2%D0%B83_%D0%B0%D0%BB%D0%B5%D0%BA%D1%81.jpg",
        "age": 1,
        "rate": 8,
        "favourite": false,
    ...
    {
        "name": "Дуся",
        "img_link": "/2022-02/B1444207-6EE3-4BA4-97F7-2F9666AE2F63.jpeg",
        "age": 1,
        "rate": 9,
        "favourite": false,
    ...
    {
        "name": "Бруно",
        "img_link": "/2022-01/IMG-20211223-WA0049.jpg",
        "age": 1,
        "rate": 10,
        "favourite": false,
    ...
    {
        "name": "Светлячок",
        "img_link": "/2022-01/%D1%81%D0%B2%D0%B5%D1%82%D0%BB%D1%8F%D1%87%D0%BE%D0%BA4_%D0%B0%D0%BB%D0%B5%D0%BA%D1%81.jpg",
        "age": 1,
        "rate": 9,
        "favourite": true,
...
const catList = document.getElementById("app");
catList.style.display = "grid";
catList.style.gridTemplateColumns = "repeat( auto-fill, minmax(270px, 1fr) )";
catList.style.justifyContent = "center";
catList.style.gap = "10px";
catList.style.marginInline = "10px";
...
cats.forEach((cat, idx) => {
    ...
    catImg.src = 'https://www.friendforpet.ru/api/sites/default/files' + cat.img_link;
    catImg.loading = "lazy";
    catImg.alt = cat.name;
